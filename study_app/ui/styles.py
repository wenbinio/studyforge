"""
styles.py — Shared styling constants for StudyForge UI.
"""
...
COLORS = {
    ...
    "accent_hover": "#7f70f0",
    "accent_alt": "#8b5cf6",
    "accent_alt_hover": "#7c3aed",
    "accent_light": "#a29bfe",
    "success": "#00b894",
    "success_hover": "#00d2a0",
    "warning": "#fdcb6e",
    "warning_hover": "#f0be50",
    "danger": "#e17055",
    "danger_hover": "#c0392b",
    "text_primary": "#f0f0f5",
...
FONTS = {
    ...
    "small": ("Segoe UI", 11),
    "timer": ("Consolas", 64, "bold"),
    "timer_label": ("Segoe UI", 14),
    "card_front": ("Segoe UI", 16),
    "card_back": ("Segoe UI", 14),
    "mono": ("Consolas", 12),
