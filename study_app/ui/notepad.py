...
class NotepadTab(ctk.CTkFrame):
    ...
    def _build_ui(self):
        ...
        header.grid(row=0, column=0, sticky="ew", padx=notepad_padx, pady=(PADDING["page"], 5))
        ...
        self.editor_frame.grid(row=4, column=0, sticky="nsew", padx=notepad_padx, pady=(0, PADDING["page"]))
