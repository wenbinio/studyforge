...
class ParticipationTab(ctk.CTkFrame):
    ...
    def build_ui(self):
        ...
        override = config.get("claude_model_participation", "")
        ...
        filter_f.pack(fill="x", padx=PAD["page"], pady=(0, PAD["el"]))
    ...
    def _save_model(self, value):
        ...
        cfg.update_setting("claude_model_participation", model)
    ...
    def _show_questions(self):
        ...
        category_colors = {
            "interesting": COLORS["warning"],
            "unanswered": COLORS["danger"],
