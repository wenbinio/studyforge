"""notepad.py — Comprehensive Notepad tab for StudyForge v2.
...
class NotepadTab(ctk.CTkFrame):
    ...
    def _build_ui(self):
        ...
        self.focus_btn = ctk.CTkButton(btn_row, text="🖥️ Focus Mode", width=120, height=34,
        ...
        self.preview_btn = ctk.CTkButton(btn_row, text="👁️ Preview", width=100, height=34,
            font=FONTS["body"], fg_color=COLORS["bg_card"], hover_color=COLORS["accent_hover"],
            corner_radius=8, command=self._toggle_preview)
        self.preview_btn.pack(side="left", padx=4)

        self.nav_visible = False
        self.nav_btn = ctk.CTkButton(btn_row, text="Navigator", width=100, height=34,
            font=FONTS["body"], fg_color=COLORS["bg_card"], hover_color=COLORS["accent_hover"],
            corner_radius=8, command=self._toggle_navigator)
        self.nav_btn.pack(side="left", padx=4)

        ctk.CTkButton(btn_row, text="💾 Save", width=80, height=34, font=FONTS["body"],
            fg_color=COLORS["success"], hover_color="#00d2a0", corner_radius=8,
            command=self._save_note).pack(side="left", padx=4)

        ctk.CTkButton(btn_row, text="📄 New", width=80, height=34, font=FONTS["body"],
        ...
        self.title_entry = ctk.CTkEntry(title_frame, placeholder_text="Note title...",
            ...
            font=FONTS["subheading"], border_color=COLORS["border"], corner_radius=8, height=38)
        ...
        self.note_selector = ctk.CTkOptionMenu(selector_frame, values=["— New Note —"],
        ...
        ctk.CTkButton(selector_frame, text="🗑️ Delete", width=70, height=28,
            font=FONTS["small"], fg_color=COLORS["danger"], corner_radius=6,
            command=self._delete_current_note).pack(side="left", padx=4)

        self.status_label = ctk.CTkLabel(selector_frame, text="", font=FONTS["small"],
        ...
        self.editor = ctk.CTkTextbox(self.editor_frame, fg_color=COLORS["bg_input"],
        ...
        self.preview_panel = ctk.CTkTextbox(self.editor_frame, fg_color=COLORS["bg_card"],
    ...
    def _delete_current_note(self):
        ...
        dialog.grab_set()
        ctk.CTkLabel(dialog, text="⚠️ Delete this note?\nThis cannot be undone.",
            font=FONTS["body"], text_color=COLORS["text_primary"], justify="center").pack(pady=(20, 15))
        ...
        ctk.CTkButton(btn_row, text="🗑️ Delete", width=100, height=34, font=FONTS["body_bold"],
            fg_color=COLORS["danger"], corner_radius=8, command=confirm).pack(side="left", padx=6)
        ctk.CTkButton(btn_row, text="Cancel", width=100, height=34, font=FONTS["body"],
            fg_color=COLORS["bg_secondary"], corner_radius=8, command=dialog.destroy).pack(side="left", padx=6)
