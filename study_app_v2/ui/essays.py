...
class EssaysTab(ctk.CTkFrame):
    ...
    def build_ui(self):
        ...
        override = config.get("claude_model_essays", "")
        ...
        create_card.pack(fill="x", padx=PAD["page"], pady=(0, PAD["el"]))

        cf_top = ctk.CTkFrame(create_card, fg_color="transparent")
        cf_top.pack(fill="x", padx=PAD["section"], pady=(PAD["section"], 8))
        ...
        rf.pack(fill="x", padx=PAD["section"], pady=(0, 5))
        ...
        self.prompt_tb.pack(fill="x", padx=PAD["section"], pady=(0, 8))
    ...
    def _save_model(self, value):
        ...
        cfg.update_setting("claude_model_essays", model)
    ...
    def _refresh_rubrics(self):
        self.rubrics = db.get_all_rubrics()
        # Rebuild UI to update rubric dropdown
    ...
    def _show_essay(self, eid):
        ...
        prompt_tb.pack(fill="x", padx=PAD["section"], pady=(0, PAD["section"]))
        ...
        if essay.get("rubric_id"):
            ...
            if rubric:
                ...
                ctk.CTkLabel(rub_c, text=f"📋 Rubric: {rubric['name']}", font=FONTS["body_bold"],
                    text_color=COLORS["warning"]).pack(padx=PAD["section"], pady=(PAD["section"], 4), anchor="w")
                ...
                rub_tb.pack(fill="x", padx=PAD["section"], pady=(0, PAD["section"]))
